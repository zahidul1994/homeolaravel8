...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('app-assets/css/pages/app-email.css')); ?>">
<?php $__env->stopSection(); ?>
        ...
        <div class="card-content p-0 pb-2">
          ...
          <div class="collection email-collection">
            ...
            <div class="email-brief-info collection-item animate fadeUp delay-1">
              ...
              <a class="list-content" href="<?php echo e(url('superadmin/replymail/'.$contact->id)); ?>">
                <div class="list-title-area">
                  <div class="user-media">
                    <img src="<?php echo e(asset('images/user/not-found.jpg')); ?>" alt="" class="circle z-depth-2 responsive-img avtar tooltipped" data-position="bottom"  data-tooltip="<?php echo e($contact->name); ?>">
                    <div class="list-title"><?php echo e($contact->subject); ?></div>
                  </div>
                  
                </div>
                <div class="list-desc"><?php echo e($contact->message); ?></div>
              </a>
              <div class="list-right">
                <div class="list-date"><?php echo e($contact->created_at->diffForHumans()); ?> </div>
              </div>
            </div>
...
<script src="<?php echo e(asset('app-assets/js/scripts/app-email.js')); ?>"></script>
<script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadminMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\laravel8\Homeobari\resources\views/superadmin/contact/index.blade.php ENDPATH**/ ?>