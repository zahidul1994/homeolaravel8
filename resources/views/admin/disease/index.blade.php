            ...
            <div class="card-content">
              <div class="input-field col s12 m9">
                ...
                <div class="col s12 m3 l3 input-field">
                    ...
                    <a href="{{url('admin/createdisease')}}" class="waves-effect waves-light  btn "><i class="material-icons right">gps_fixed</i> Create New</a>
                </div>
                            ...
                            <tbody>
                              ...
                              @foreach ($diseases as $disease)
                               ...
                               <td>@if($disease->status==1)
                                      <button type="button"  class="btn-floating mb-1 waves-effect waves-light approved" rid="{{$disease->id}}"><i class="material-icons">beenhere</i></button> @else
                                      <button type="button" class="btn-floating mb-1 waves-effect waves-light notapproved"  rid="{{$disease->id}}"><i class="material-icons">block</i> </button>
                                   @endif</td>
                                   <td>
                                    <a href="{{url('admin/editdisease/'.$disease->id) }}" class="btn-floating mb-1 waves-effect waves-light">
                                      <i class="material-icons">edit</i>
                                    </a>
                                  </td>
                                   
                                      <td> {!! Form::open(['method' => 'DELETE','url' => ['admin/deletedisease', $disease->id],'onsubmit' => 'return confirm("are you sure ?")']) !!}
