...
class Admin extends Authenticatable implements MustVerifyEmail
{
 use Notifiable;
    ...
    protected $fillable = [
      'email_verified_at', 'superadmin_id','phone','name','image', 'email', 'password','status','gender','remember_token','username','profession','aboutyou','coverphoto','country','address','actype'
    ];
