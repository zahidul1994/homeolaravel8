...
class MedicineController extends Controller
{
    ...
    {  $pageConfigs = ['pageHeader' => false, 'isFabButton' => false];
        ...
        return view('admin.medicine.index',['pageConfigs' => $pageConfigs])->with('medicines',$medicine)->with('i', (request()->input('page', 1) - 1) * 10);
    ...
    {
        $breadcrumbs = [
            ['link' => "admin", 'name' => "Home"], ['link' => "admin/medicinelist", 'name' => "Medicine"], ['name' => "Create"],
        ];
        //Pageheader set true for breadcrumbs
        $pageConfigs = ['pageHeader' => true, 'isFabButton' => false];
        return view('admin.medicine.create', ['pageConfigs' => $pageConfigs], ['breadcrumbs' => $breadcrumbs]);
    }
...
$this->validate($request,[
    ...
    $userinfo = new Medicine(array(
        ...
        if($userinfo->save()){
            ...
            return Redirect::to('admin/medicinelist'); 
        }
        else {
    ...
    {
        $breadcrumbs = [
            ['link' => "admin", 'name' => "Home"], ['link' => "admin/medicinelist", 'name' => "Medicine"], ['name' => "Edit"],
        ];
        //Pageheader set true for breadcrumbs
        $pageConfigs = ['pageHeader' => true, 'isFabButton' => false];
        $medicine =Medicine::find($id);
        return view('admin.medicine.edit', ['pageConfigs' => $pageConfigs], ['breadcrumbs' => $breadcrumbs])->with('medicines',$medicine);
    }
