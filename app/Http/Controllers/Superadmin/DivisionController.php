...
class DivisionController extends Controller
{
    public function index(){
     ...
     $breadcrumbs = [
        ...
        return view('superadmin.division.create', ['pageConfigs' => $pageConfigs], ['breadcrumbs' => $breadcrumbs]);
      ...
      public function edit($id){
        $breadcrumbs = [
           ...
           return view('superadmin.division.edit', ['pageConfigs' => $pageConfigs], ['breadcrumbs' => $breadcrumbs])->with('divisioninfo',$divisioninfo);
